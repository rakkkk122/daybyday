...
echo ""
echo "============================================"
echo "  RECOMMENDED: Setup One-Tap Launcher"
echo "============================================"
echo "Biar tidak perlu buka Termux + ketik command setiap kali:"
echo ""
echo "  1. Install Termux:Widget (dari F-Droid):"
echo "     https://f-droid.org/packages/com.termux.widget/"
echo ""
echo "  2. Jalankan setup launcher:"
echo "     bash setup-launcher.sh"
echo ""
echo "  3. Tambah widget ke Home Screen (instruksi di script)"
echo ""
echo "Setelah itu, tinggal TAP ICON di Home Screen:"
echo "  → Server jalan + Chrome buka + Termux close sendiri"
echo "  → Tidak perlu buka Termux lagi!"
